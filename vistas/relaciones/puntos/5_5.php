          ...
          <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                5.5 Capacitar al personal de la Oficina de Asuntos Sindicales y de la Subcomisión Mixta de Jubilaciones y Pensiones para la atención y emisión de resoluciones de otorgamiento de Pensiones de Invalidez y de Riesgo de Trabajo.
	Minuta de sesión de capacitación y lista de asistencia
	Implementar un control a través de una base de datos que  permita dar seguimiento a las solicitudes recibidas y enviadas a la CNMJP para su atención. 
	Archivo Excell de base de datos.
          ...
          <form id="uploadForm">
            ...
            <input type="hidden" name="num_punto" value="5.5"> <!-- Reemplazar VALOR_DE_NUM_PUNTO con el valor adecuado -->
            <div class="form-group">
            ...
            <div class="table-responsive">
              <table class="table table-hover table-condensed" id="tablaFuerza">
                ...
                <?php
                    ...
                    WHERE CAST(num_punto AS DECIMAL(10, 2)) = 5.5;  ";
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                alert('Los archivos se han archivado correctamente!');
                 window.location.replace('5_5.php');
            },
