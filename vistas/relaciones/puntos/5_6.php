      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="100">
        <div class="col-xl-6 col-lg-8">
          ...
          <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                5.6 El Departamento de Relaciones Laborales adicionará en la base de datos del seguimiento a las Licencias Contractuales y Extracontrato dos columnas, una en la que se indique el número de oficio con que se envía a la CRL y otra en la que señale el oficio con que se autorizó o negó.
          ...
          <form id="uploadForm">
            ...
            <input type="hidden" name="num_punto" value="5.6"> <!-- Reemplazar VALOR_DE_NUM_PUNTO con el valor adecuado -->
            <div class="form-group">
            ...
            <div class="table-responsive">
              <table class="table table-hover table-condensed" id="tablaFuerza">
                ...
                <?php
                    ...
                    WHERE CAST(num_punto AS DECIMAL(10, 2)) = 5.6;  ";
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                alert('Los archivos se han archivado correctamente!');
                 window.location.replace('5_6.php');
            },
