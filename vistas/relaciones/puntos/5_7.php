      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="100">
        <div class="col-xl-8 col-lg-8">
          ...
          <form id="uploadForm">
            ...
            <input type="hidden" name="num_punto" value="5.7"> <!-- Reemplazar VALOR_DE_NUM_PUNTO con el valor adecuado -->
            <div class="form-group">
            ...
            <div class="table-responsive">
              <table class="table table-hover table-condensed" id="tablaFuerza">
                ...
                <?php
                    ...
                    WHERE CAST(num_punto AS DECIMAL(10, 2)) = 5.7;  ";
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                alert('Los archivos se han archivado correctamente!');
                 window.location.replace('5_7.php');
            },
