      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="100">
        <div class="col-xl-6 col-lg-8">
          ...
          <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                5.2 Complementar los controles internos agregando campos adicionales, a fin de dar un seguimiento oportuno a las solicitudes recibidas para trámite de Licencias y Jubilaciones.
	            Incorporar campos de fechas de registro de solicitudes, fecha de atención.
                </div>
          ...
          <form id="uploadForm">
            ...
            <input type="hidden" name="num_punto" value="5.2"> <!-- Reemplazar VALOR_DE_NUM_PUNTO con el valor adecuado -->
            <div class="form-group">
            ...
            <div class="table-responsive">
              <table class="table table-hover table-condensed" id="tablaFuerza">
                ...
                <?php
                    ...
                    WHERE CAST(num_punto AS DECIMAL(10, 2)) = 5.2;  ";
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                alert('Los archivos se han archivado correctamente!');
                 window.location.replace('5_2.php');
            },
