          ...
          <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                5.3 Informar a la Coordinación de Relaciones Laborales sobre los mecanismos a implementar a fin de disminuir el tiempo de pago 
	Implementgar control de tiempo de liquidación (archivo Excel).
                </div>
          ...
          <form id="uploadForm">
            ...
            <input type="hidden" name="num_punto" value="5.3"> <!-- Reemplazar VALOR_DE_NUM_PUNTO con el valor adecuado -->
            <div class="form-group">
            ...
            <div class="table-responsive">
              <table class="table table-hover table-condensed" id="tablaFuerza">
                ...
                <?php
                    ...
                    WHERE CAST(num_punto AS DECIMAL(10, 2)) = 5.3;  ";
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                alert('Los archivos se han archivado correctamente!');
                 window.location.replace('5_3.php');
            },
