          ...
          <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                1.10 Revisar, justificar cada caso 
	Dar seguimiento para envio a Laborales y aquellos no justificados serán para el deslinde de responsabilidades
	Enviar Oficio o correo sobre el uso adecuado de las vacaciones, así mismo atender el tema en la capcitación que realiz la Oficina en la difusión de la normativa
	Calendario de supervisión de vacaciones 2024
                </div>
          ...
          <form id="uploadForm">
            ...
            <input type="hidden" name="num_punto" value="1.10"> <!-- Reemplazar VALOR_DE_NUM_PUNTO con el valor adecuado -->
            <div class="form-group">
            ...
            <div class="table-responsive">
              <table class="table table-hover table-condensed" id="tablaFuerza">
                ...
                <?php
                    ...
                    WHERE CAST(num_punto AS DECIMAL(10, 2)) = 1.10;  ";
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                alert('Los archivos se han archivado correctamente!');
                 window.location.replace('1_10.php');
            },
