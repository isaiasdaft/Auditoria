...
$consulta_texto = "SELECT observacion FROM observaciones WHERE num_punto = 3.4"; // Ajusta la consulta según tu estructura de base de datos
            ...
            <div class="table-responsive">
              <table class="table table-hover table-condensed" id="tablaFuerza">
                ...
                <?php
                    ...
                    WHERE CAST(num_punto AS DECIMAL(10, 2)) = 3.4;  ";
