      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="100">
        <div class="col-xl-6 col-lg-8">
          ...
          <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                3.6 Seguimiento a cuenta detectada con diferencia, corresponde a un salario cancelado de un trabajador que paso a la nómina de jubilados y que será recuperado a través de la nómina  en en mes de diciembre de 2023.
                </div>
          ...
          <form id="uploadForm">
            ...
            <input type="hidden" name="num_punto" value="3.6"> <!-- Reemplazar VALOR_DE_NUM_PUNTO con el valor adecuado -->
            <div class="form-group">
            ...
            <div class="table-responsive">
              <table class="table table-hover table-condensed" id="tablaFuerza">
                ...
                <?php
                    ...
                    WHERE CAST(num_punto AS DECIMAL(10, 2)) = 3.6;  ";
           ...
           url: 'uploadPresta.php',
            ...
            success: function(response) {
                ...
                alert('Los archivos se han archivado correctamente!');
                 window.location.replace('3_6.php');
            },
