      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="100">
        <div class="col-xl-6 col-lg-8">
          ...
          <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                1.6 Indicar a las Jefaturas de Servicios y  Coordinaciones del OOAD, que se emita y entregue de manera diaria y oportuna el formato "Control diario de ausentismo”, conforme a la normatividad vigente	
                  Oficio firmado por el Titular para el control diario de ausentismo
                  Oficio para personal operativo de APS
                </div>
          ...
          <form id="uploadForm">
            ...
            <input type="hidden" name="num_punto" value="1.6"> <!-- Reemplazar VALOR_DE_NUM_PUNTO con el valor adecuado -->
            <div class="form-group">
            ...
            <div class="table-responsive">
              <table class="table table-hover table-condensed" id="tablaFuerza">
                ...
                <?php
                    ...
                    WHERE CAST(num_punto AS DECIMAL(10, 2)) = 1.6;  ";
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                alert('Los archivos se han archivado correctamente!');
                 window.location.replace('1_6.php');
            },
