      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="100">
        <div class="col-xl-6 col-lg-8">
          ...
          <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                4.4 La Sección de Retiro Laboral en el OOAD de Aguascalientes, analice los registros identificados para su actualización y/o corrección en Sistema, así como establecer comunicación con el Área normativa, para la atención correspondiente conforme al calendario de los procesos de nómina.
                </div>
          ...
          <form id="uploadForm">
            ...
            <input type="hidden" name="num_punto" value="4.4"> <!-- Reemplazar VALOR_DE_NUM_PUNTO con el valor adecuado -->
            <div class="form-group">
            ...
            <div class="table-responsive">
              <table class="table table-hover table-condensed" id="tablaFuerza">
                ...
                <?php
                    ...
                    WHERE CAST(num_punto AS DECIMAL(10, 2)) = 4.4;  ";
          ...
          url: 'uploadRetiro.php',
            ...
            success: function(response) {
                ...
                alert('Los archivos se han archivado correctamente!');
                 window.location.replace('4_4.php');
            },
