          ...
          <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                1.3 Seguimiento al Calendario de supervisión establecido, así como, a los hallazgos encontrados en las supervisiones practicadas, conforme a la fecha de compromiso de las medidas preventivas y/o correctivas de cada Unidad de Servicio
	Capacitación a los responsables de los servicios de personal en las Unidades de Servicio, para que estén en posibilidad de reforzar los temas Normativos en que tuvieron mayor incidencia
	Supervisar el óptimo desarrollo del proceso de APS; conforme a la política 4.1.8 y 4.1.10 del Procedimiento para el control de asistencia, puntualidad y sustituciones
	Envíar correo electronico a las Unidades con el fundamento normativo de las supervisiones (para reforzar el tema).
                </div>
          ...
          <form id="uploadForm">
            ...
            <input type="hidden" name="num_punto" value="1.3"> <!-- Reemplazar VALOR_DE_NUM_PUNTO con el valor adecuado -->
            <div class="form-group">
            ...
            <div class="table-responsive">
              <table class="table table-hover table-condensed" id="tablaFuerza">
                ...
                <?php
                    ...
                    WHERE CAST(num_punto AS DECIMAL(10, 2)) = 1.3;  ";
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                alert('Los archivos se han archivado correctamente!');
                 window.location.replace('1_3.php');
            },
