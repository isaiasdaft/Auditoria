          ...
          <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                2.3 La Subcomisión Mixta, deberá implementar las estrategias que considere pertinentes, para garantizar el correcto requisitado de los formatos de designación en cada uno de los rubros.
	Minuta de trabajo entre la Jefatura y Sección de Confianzas B
                </div>
          ...
          <form id="uploadForm">
            ...
            <input type="hidden" name="id_punto" value="2"> <!-- Reemplazar VALOR_DE_ID_PUNTO con el valor adecuado -->
            <input type="hidden" name="num_punto" value="2.3"> <!-- Reemplazar VALOR_DE_NUM_PUNTO con el valor adecuado -->
            <div class="form-group">
            ...
            <div class="table-responsive">
              <table class="table table-hover table-condensed" id="tablaFuerza">
                ...
                <?php
                    ...
                    WHERE CAST(num_punto AS DECIMAL(10, 2)) = 2.3;  ";
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                alert('Los archivos se han archivado correctamente!');
                 window.location.replace('2_3.php');
            },
