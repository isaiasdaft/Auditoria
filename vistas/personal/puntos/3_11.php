      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="100">
        <div class="col-xl-6 col-lg-8">
          ...
          <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                3.11 Fortalecer con el personal el conocimiento del procedimiento de la materia, así como el proceso de descarga de certificados a fin de que orienten y asesoren a los trabajadores sobre los medios por los que pueden obtener los certificados. Asimismo, sensibilizar a los trabajadores sobre este seguro, mismos que desconocen su existencia y beneficios. (capacitación)
                </div>
          ...
          <form id="uploadForm">
            ...
            <input type="hidden" name="num_punto" value="3.11"> <!-- Reemplazar VALOR_DE_NUM_PUNTO con el valor adecuado -->
            <div class="form-group">
            ...
            <div class="table-responsive">
              <table class="table table-hover table-condensed" id="tablaFuerza">
                ...
                <?php
                    ...
                    WHERE CAST(num_punto AS DECIMAL(10, 2)) = 3.11;  ";
                  ...
                  <tr>
                    ...
                    <td>
                       <a href="downloadPrestaciones.php?file=<?php echo $name; ?>" >
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                alert('Los archivos se han archivado correctamente!');
                 window.location.replace('3_11.php');
            },
