          ...
          <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                4.3 Dar continuidad a las actividades de monitoreo y reforzar los esfuerzos y mecanismos para concluir con los casos restantes.
	La Sección de Retiro Laboral, inste a los beneficiarios de la ayuda de Gastos de Funeral, a gestionar el trámite correspondiente, a efecto de realizar la recuperación de los pagos de los 15 casos detectad	
	Difusión a través de correo electrónico institucional
	Presentación PPT
	Difusión en curso pre-jubilatorio
	Apoyo con la Coordinación de Comunicación Social para la difusión de tríptico.
                </div>
          ...
          <form id="uploadForm">
            ...
            <input type="hidden" name="id_punto" value="4"> <!-- Reemplazar VALOR_DE_ID_PUNTO con el valor adecuado -->
            <input type="hidden" name="num_punto" value="4.3"> <!-- Reemplazar VALOR_DE_NUM_PUNTO con el valor adecuado -->
            <div class="form-group">
            ...
            <div class="table-responsive">
              <table class="table table-hover table-condensed" id="tablaFuerza">
                ...
                <?php
                    ...
                    WHERE CAST(num_punto AS DECIMAL(10, 2)) = 4.3;  ";
                  ...
                  <tr>
                    ...
                    <td>
                       <a href="downloadRetiro.php?file=<?php echo $name; ?>" >
...
<p></p>
<br>
      <a href="../retiroLaboral.php" class="btn-custom btn-lg">
          ...
          url: 'uploadRetiro.php',
            ...
            success: function(response) {
                ...
                alert('Los archivos se han archivado correctamente!');
                 window.location.replace('4_3.php');
            },
