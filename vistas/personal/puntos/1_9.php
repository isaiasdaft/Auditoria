          ...
          <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                1.9 Realizar la integración y la actualización de la hoja de datos (febrero y septiembre de cada año) de los trabajadores adscritos a la Sede del OOAD.
	Oficio y correo para los Jefes y personal a su cargo
                </div>
          ...
          <form id="uploadForm">
            ...
            <input type="hidden" name="num_punto" value="1.9"> <!-- Reemplazar VALOR_DE_NUM_PUNTO con el valor adecuado -->
            <div class="form-group">
            ...
            <div class="table-responsive">
              <table class="table table-hover table-condensed" id="tablaFuerza">
                ...
                <?php
                    ...
                    WHERE CAST(num_punto AS DECIMAL(10, 2)) = 1.9;  ";
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                alert('Los archivos se han archivado correctamente!');
                 window.location.replace('1_9.php');
            },
