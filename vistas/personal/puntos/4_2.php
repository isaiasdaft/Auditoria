          ...
          <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                4.2 Solicitud para especificar los casos detectados y anteder la observación
	Establecer contacto con el jubilado o pensionado, para solicitarle la documentación faltante e incorporarla a su expediente.
	Incorporar un control interno (check list) que enliste los documentos que debe contener el expediente del jubilado o pensionado; e implementar un mecanismo de control físico y electrónico de expedientes para su localización, acceso y uso.
                </div>
          ...
          <form id="uploadForm">
            ...
            <input type="hidden" name="num_punto" value="4.2"> <!-- Reemplazar VALOR_DE_NUM_PUNTO con el valor adecuado -->
            <div class="form-group">
            ...
            <div class="table-responsive">
              <table class="table table-hover table-condensed" id="tablaFuerza">
                ...
                <?php
                    ...
                    WHERE CAST(num_punto AS DECIMAL(10, 2)) = 4.2;  ";
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                alert('Los archivos se han archivado correctamente!');
                 window.location.replace('4_2.php');
            },
