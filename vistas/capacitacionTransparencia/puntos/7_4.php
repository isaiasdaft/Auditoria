          ...
          <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                7.4 llevar  a cabo un programa de ordenamiento de documentos que integran el expediente histórico de personal (21.11.23)
	Continuar con el proceso de digitalización de aquellos expedientes posibles de escanear.
          ...
          <form id="uploadForm">
            ...
            <input type="hidden" name="id_punto" value="7"> <!-- Reemplazar VALOR_DE_ID_PUNTO con el valor adecuado -->
            <input type="hidden" name="num_punto" value="7.4"> <!-- Reemplazar VALOR_DE_NUM_PUNTO con el valor adecuado -->
            <div class="form-group">
            ...
            <div class="table-responsive">
              <table class="table table-hover table-condensed" id="tablaFuerza">
                ...
                <?php
                    ...
                    WHERE CAST(num_punto AS DECIMAL(10, 2)) = 7.4;  ";
                  ...
                  <tr>
                    ...
                    <td>
                       <a href="downloadTransparencia.php?file=<?php echo $name; ?>" >
...
<p></p>
<br>
      <a href="../transparencia.php" class="btn-custom btn-lg">
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                alert('Los archivos se han archivado correctamente!');
                 window.location.replace('7_4.php');
            },
