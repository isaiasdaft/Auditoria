            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                    6.1 Que la JSDP intervenga en Cuerpo de Gobierno, para que el 100% de las Jefaturas, Coordinaciones, Unidades Médicas y No Médicas se comprometan a participar con todo su personal en la diagnóstico de la DNC
	Programa de trabajo (realizar encuestas)
	Estrategía Adelantar la DNC a Junio para inciar con anticipación este proceso
          ...
          <form id="uploadForm">
            ...
            <input type="hidden" name="id_punto" value="6"> <!-- Reemplazar VALOR_DE_ID_PUNTO con el valor adecuado -->
            <input type="hidden" name="num_punto" value="6.1"> <!-- Reemplazar VALOR_DE_NUM_PUNTO con el valor adecuado -->
            <div class="form-group">
          ...
          <div class="col-sm-12">
            <div class="table-responsive">
              <table class="table table-hover table-condensed" id="tablaFuerza">
                ...
                <tbody>
                <?php
                    $consulta = "SELECT archivos_capacitacion.id, archivos_capacitacion.nombre_archivo,
                    tamano, tipo, fecha_subido FROM archivos_capacitacion 
                    WHERE CAST(num_punto AS DECIMAL(10, 2)) = 6.1;  ";
                  ...
                  <tr>
                    ...
                    <td>
                       <a href="downloadCapa.php?file=<?php echo $name; ?>" >
...
<p></p>
<br>
      <a href="../capa.php" class="btn-custom btn-lg">
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                alert('Los archivos se han archivado correctamente!');
                 window.location.replace('6_1.php');
            },
