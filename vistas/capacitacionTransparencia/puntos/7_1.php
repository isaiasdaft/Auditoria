          ...
          <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                7.1 Programa de difusió de la normativa
	Revisión, verifiación y actualizaciónn de normativa de manera mensual
	Envió de correo electrónico
	Ciclos de actualización de la normativa
	Supervisión por Departamento (pruebas muestra)
          ...
          <form id="uploadForm">
            ...
            <input type="hidden" name="num_punto" value="7.1"> <!-- Reemplazar VALOR_DE_NUM_PUNTO con el valor adecuado -->
            <div class="form-group">
            ...
            <div class="table-responsive">
              <table class="table table-hover table-condensed" id="tablaFuerza">
                ...
                <?php
                    ...
                    WHERE CAST(num_punto AS DECIMAL(10, 2)) = 7.1;  ";
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                alert('Los archivos se han archivado correctamente!');
                 window.location.replace('7_1.php');
            },
