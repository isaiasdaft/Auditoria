          ...
          <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                8.1 Calendarización de conceptos extraordinarios,
	Envío correo electrónico del día 30 de octubre de 2023, realizando la solicitud de calendarización de presupuesto para conceptos extraordinarios 2024
	a todas las unidades médicas y no médicas del Órgano de Operación Administrativa Desconcentrada Estatal en Aguascalientes para el ejercicio 2024.
    Lineamientos en coordinación con el Departamento de Personal,
	Se envian correo electrónicos del día 6 de noviembre, enviando a todas las unidades médicas y no médicas del Órgano de Operación Administrativa Desconcentrada
	Estatal en Aguascalientes, los lineamientos operativos vigentes para conceptos extraordinarios.
          ...
          <form id="uploadForm">
            ...
            <input type="hidden" name="id_punto" value="8"> <!-- Reemplazar VALOR_DE_ID_PUNTO con el valor adecuado -->
            <input type="hidden" name="num_punto" value="8.1"> <!-- Reemplazar VALOR_DE_NUM_PUNTO con el valor adecuado -->
            <div class="form-group">
          ...
          <div class="col-sm-12">
            <div class="table-responsive">
              <table class="table table-hover table-condensed" id="tablaFuerza">
                ...
                <tbody>
                <?php
                    $consulta = "SELECT archivos_presupuesto.id, archivos_presupuesto.nombre_archivo,
                    tamano, tipo, fecha_subido FROM archivos_presupuesto 
                    WHERE CAST(num_punto AS DECIMAL(10, 2)) = 8.1;  ";
                  ...
                  <tr>
                    ...
                    <td><?php echo $date; ?></td>
                    <td>
                       <a href="downloadPresupuesto.php?file=<?php echo $name; ?>" >
...
<p></p>
<br>
      <a href="../gestionGastos.php" class="btn-custom btn-lg">
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                alert('Los archivos se han archivado correctamente!');
                 window.location.replace('8_1.php');
            },
